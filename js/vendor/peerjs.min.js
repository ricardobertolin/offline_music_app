/*! PeerJS v1.5.4 — https://peerjs.com — MIT licence. Vendored so the app shell
    stays self-contained: nothing is fetched from a CDN at runtime, and a session
    over a self-hosted broker works with no internet at all.
